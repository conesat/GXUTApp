...
import com.hg.gxutapp.model.MusicData;
import com.hg.gxutapp.service.MusicService;
import com.hg.gxutapp.utils.DisplayUtil;
import com.hg.gxutapp.utils.FastBlurUtil;
import com.hg.gxutapp.widget.BackgourndAnimationRelativeLayout;
import com.hg.gxutapp.widget.DiscView;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import static com.hg.gxutapp.widget.DiscView.DURATION_NEEDLE_ANIAMTOR;
...
public class MusicActivity extends AppCompatActivity implements DiscView.IPlayInfo, View
    ...
    private void initMusicDatas() {
        MusicData musicData1 = new MusicData(R.raw.music1, R.raw.ic_music1, "答案", "熙宝/全玺霖");
        MusicData musicData2 = new MusicData(R.raw.music2, R.raw.ic_music2, "她说", "宇西");
        MusicData musicData3 = new MusicData(R.raw.music3, R.raw.ic_music3, "东西", "很美味");
